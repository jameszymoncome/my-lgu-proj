...
function EncoderPAR_ICS1() {
  ...
  return (
    <div style={{ display: "flex" }}>
      ...
      >
        <List>
          <ListItem button onClick={() => handleListItemClick(0, "/home-encoder")}>
            <ListItemIcon><HomeIcon /></ListItemIcon>
            <ListItemText primary="Home" />
          </ListItem>
          <ListItem button onClick={() => handleListItemClick(1, "/encoder-ppeentry")}>
            <ListItemIcon><AssignmentIcon /></ListItemIcon>
            <ListItemText primary="PPE Entry Form" />
          </ListItem>
          <ListItem button onClick={() => handleListItemClick(2, "/encoder-inveninspect")}>
          ...
          <ListItem button onClick={() => handleListItemClick(6, "/encoder-profile")}>
...
export default EncoderPAR_ICS1;
