...
function UserPAR_ICS1() {
  ...
  return (
    <div style={{ display: "flex" }}>
      ...
      >
        <List>
          <ListItem button onClick={() => handleListItemClick(0, "/home-user")}>
          ...
          <ListItem button onClick={() => handleListItemClick(6, "/user-profile")}>
