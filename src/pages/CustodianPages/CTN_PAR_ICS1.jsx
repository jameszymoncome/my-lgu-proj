...
function CTN_PAR_ICS1() {
  ...
  const getData = async () => {
    ...
    if (!userId) return;
    try {
      const response = await axios.get(`http://ppemanagement.andrieinthesun.com/ctn_getParIcs.php?user_id=${userId}`);
