      ...
      <Drawer
            ...
            >
              <List>
                ...
                <ListItem button onClick={() => handleListItemClick("/ctn-purchase-request")} style={{ color: "#0F1D9F"}}>
                  <ListItemIcon>
...
export default CTN_PurchaseRequest;