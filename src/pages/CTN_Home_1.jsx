...
const CTN_Home_1 = () => {
  ...
  useEffect(() => {
    ...
    useEffect(() => {
      ...
      fetch(`https://ppemanagement.andrieinthesun.com/ctn_home_details.php?user_id=${userId}`)
        .then(res => res.json())
        .then(data => {
          if (data.success) {
            setDashboardStats({
  ...
  return (
    <div className="home-container">
      ...
      >
        <List>
          <ListItem button onClick={() => handleListItemClick("/ctn-home-1")} style={{ color: "#0F1D9F"}}>
            <ListItemIcon>
      ...
      <div className="main-contents">
            <header className="home-header">
                <div className="header-content">
                    <h1>Welcome Custodian, to the Inventory Management System
                    </h1>
                </div>
